...
module.exports.categories = {
	"Торговцы": [
		...
		{ command: "m $Merchant", name: "Merchant", color: c.o, ifcmd: "bh" },
	],
		"Основное": [
		...
		{ command: "dg", name: "Данжы", color: c.y, ifcmd: "dg" },
...
module.exports.pages = {
 ...
 "Loger": [
	...
	//	{ command: "logpaste", name: "Paste", color: c.y, ifcmd: "logs" },
		...
		{ command: "sr r", name: "Replacer reload", color: c.r, ifcmd: "sr" },
		{ command: "rs", name: "Replacer on/off", color: c.g, ifcmd: "rs" },
		{ command: "rs reload", name: "Replacer reload", color: c.r, ifcmd: "rs" },
		{},		
